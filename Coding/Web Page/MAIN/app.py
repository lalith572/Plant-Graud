...
filepath = 'D:\Final Year Project\Coding\Web Page\MAIN\model.h5'
...
def pred_tomato_dieas(tomato_plant):
    ...
    if pred == 0:
        ...
        return "Tomato - Tomoato Yellow Leaf Curl Virus Disease", 'Tomato-Yellow_Leaf_Curl_Virus.html'
    elif pred == 8:
        return "Tomato - Tomato Mosaic Virus Disease", 'Tomato-Mosaic_Virus.html'
...
def predict():
    if request.method == 'POST':
        ...
        file_path = os.path.join('D:\Final Year Project\Coding\Web Page\MAIN\ResultImages', filename)
        file.save(file_path)
